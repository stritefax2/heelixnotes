...
const ANTRHOPIC_MAIN_MODEL: &str = "claude-sonnet-4-20250514";
...
pub async fn send_prompt_to_llm(
    ...
    let model_to_use = match model_id.as_deref() {
        ...
        Some("claude-3-5-haiku-20241022") => "claude-3-5-haiku-20241022",
                    _ => "claude-sonnet-4-20250514", // Default to Claude 4 Sonnet
    };
...
async fn handle_success_response(
    ...
    if response.status().is_success() {
        ...
        // Read the response body as text and process it line by line
