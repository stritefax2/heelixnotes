...
const initialSteps = [
  {
    ...
    content: "Your best way to organize and query your knowledge",
  },
  {
  ...
  {
    title: "Create notes. Drop in files. Tag to projects.",
    content:
      "World's best language models - now seamlessly powered by your data.",
  }
  ,
  {
    title: "Add Knowledge With A Few Clicks",
    content: "Here are some ways to add docs to Heelix:",
    prompts: [
      "Write a note",
      "Paste text directly into document list",
      "Drop in a file",
  ...
  },
  {
    ...
    content: "The app currently supports OpenAI & Claude API keys. You can use either one to get started.",
  },
];
